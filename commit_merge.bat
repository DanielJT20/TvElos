@echo off
REM Script batch para commitar e fazer merge das mudanças do dashboard
...
echo.
echo === Fazendo commit ===
git commit -m "feat: Add admin dashboard with metrics and charts" -m "- Implement comprehensive metrics dashboard in painel.html^
- Add 4 metric cards (Total, Aprovadas, Usuarios, Videos)^
